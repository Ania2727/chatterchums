...
urlpatterns = [
    ...
    path('admin/complaints/dismiss/<int:complaint_id>/', dismiss_complaint, name='dismiss_complaint'),
    path('admin/complaints/delete-post/<int:complaint_id>/', delete_post_complaint, name='delete_post_complaint'),
    path('admin/complaints/ban-user/<int:complaint_id>/', ban_user_complaint, name='ban_user_complaint'),
    path('admin/complaints/mark-reviewed/<int:complaint_id>/', mark_complaint_reviewed, name='mark_complaint_reviewed'),
